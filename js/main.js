...
{
    for (let property in knygos) {
        console.log(property + ":");
        for (let istorija in knygos[property]) {
            console.log(knygos[property][istorija]);
        }
    }
}
{
    for (let property in knygos) {
        console.log(property + ":");
        for (let fantastika in knygos[property]) {
            console.log(knygos[property][fantastika]);
        }
    }
}
